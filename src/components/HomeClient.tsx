...
import { saveLastVisited, getLastVisited } from '@/lib/indexedDB';
...
export default function HomeClient() {
  ...
  useEffect(() => {
    const checkRedirect = async () => {
      const bypass = searchParams.get('home') === 'true';
      if (!bypass) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center px-4 pt-16">
      <div className="max-w-2xl w-full space-y-8">
          ...
          <motion.div whileHover={{ y: -4 }} transition={{ type: 'spring', stiffness: 400, damping: 10 }}>
            ...
            >
              <CardHeader className="flex items-center gap-3">
                ...
                <CardTitle className="text-base font-semibold text-blue-600 dark:text-blue-300">One-Time Budget</CardTitle>
              </CardHeader>
          ...
          <motion.div whileHover={{ y: -4 }} transition={{ type: 'spring', stiffness: 400, damping: 10 }}>
            ...
            >
              <CardHeader className="flex items-center gap-3">
                ...
                <CardTitle className="text-base font-semibold text-purple-600 dark:text-purple-300">Recurring Budget</CardTitle>
              </CardHeader>
        ...
        {/* Footer */}
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="text-xs text-muted-foreground pt-6">
